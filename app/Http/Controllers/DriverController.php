        ...
        if ($request->ajax()) {
            ...
            return Datatables::of($data)
                    ...
                    ->addColumn('action', function($row){
                           ...
                           $btn = ' <a href="'. url('driver/edit/'. $row->id) .'" class="edit btn btn-info btn-sm">Edit</a>';
                           $btn .= ' <a href="'. url('driver/hapus/'. $row->id) .'" class="edit btn btn-danger btn-sm">Hapus</a>';
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            if($request->file('foto')){
                ...
                $file-> move(public_path('foto-driver'), $filename);
            }
            User::insert([
